...
This document explains how to derive a \emph{feeding rate} $\dot N_{\text{bite}}$ (number of feeding motions per day) step-by-step from a Dynamic Energy Budget (DEB) model, given:
\begin{itemize}
...
\begin{equation}
  \dot N_{\text{bite}} = \frac{\dot V_X}{V_{\text{bite}}}\tag{13}
\end{equation}
...
Combining Eqs.~(13)--(14):
\begin{equation}
  \dot N_{\text{bite}} = \frac{\dot V_X}{\kappa_{\text{bite},V}\,V} = \frac{\dot V_X}{\kappa_{\text{bite},V}\,L^3}\tag{15}
\end{equation}
...
\begin{equation*}
  [\dot N_{\text{bite}}] = \frac{[\dot V_X]}{[V_{\text{bite}}]} = \frac{\text{volume}\,\text{time}^{-1}}{[\kappa_{\text{bite},V}]\,[L^3]} = \frac{\text{volume}\,\text{time}^{-1}}{(1)\,(\text{volume})} = \text{time}^{-1}
\end{equation*}
...
\begin{equation}
  \dot N_{\text{bite}} = \frac{\dot V_X}{\kappa_{\text{bite},A}\,L^2}\tag{18}
\end{equation}
...
\begin{equation*}
  [\dot N_{\text{bite}}] = \frac{[\dot V_X]}{[V_{\text{bite}}]} = \frac{\text{volume}\,\text{time}^{-1}}{[\kappa_{\text{bite},A}]\,[L^2]} = \frac{\text{volume}\,\text{time}^{-1}}{(\text{length})\,(\text{area})} = \frac{\text{volume}\,\text{time}^{-1}}{\text{volume}} = \text{time}^{-1}
\end{equation*}
...
\begin{tabular}{l|l|l|l}
  ...
  $\dot N_{\text{bite}}$ & feeding motions per time & time$^{-1}$ & $\dot N_{\text{bite}} = \dot{V}_X/V_{\text{bite}}$ \\
  \hline
\end{tabular}
\end{center}
...
In future experiments, the bite parameters can be estimated by combining measurements of body size, food volume flux $\dot V_X$, and feeding frequency $\dot N_{\text{bite}}$.

For Alternative A (Eq.~14):
\begin{equation}
  \kappa_{\text{bite},V} = \frac{\dot V_X}{\dot N_{\text{bite}}\,V}
\end{equation}

For Alternative B (Eq.~17):
\begin{equation}
  \kappa_{\text{bite},A} = \frac{\dot V_X}{\dot N_{\text{bite}}\,L^2}
\end{equation}
